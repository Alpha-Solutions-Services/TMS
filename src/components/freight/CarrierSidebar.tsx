...
const NAV = [
  ...
  { href: "/carrier/business", label: "Business P&L", icon: PieChart },
  { href: "/carrier/invoices", label: "Settlements", icon: FileText },
  { href: "/carrier/expenses", label: "Expenses", icon: Receipt },
  { href: "/carrier/fuel", label: "Fuel", icon: Fuel },
  { href: "/carrier/payments", label: "Money overview", icon: CreditCard },
