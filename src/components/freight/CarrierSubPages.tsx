...
export function CarrierChatPage() {
  ...
  const chatOpen = loadChatOpen || (tab === "dispatch" && dispatchOpen);
  ...
  return (
    <div className="flex h-[calc(100dvh-5rem)] flex-col bg-[var(--color-bg)] lg:h-auto lg:min-h-[calc(100vh-5rem)]">
      ...
      {loading && !data ? (
        ...
        <div className="flex min-h-0 flex-1 flex-col">
          <div
            className={`flex shrink-0 gap-2 border-b border-[var(--color-border)] px-3 py-2 sm:px-6 ${
              chatOpen ? "lg:px-8" : "lg:px-8"
            }`}
          >
            <button
              type="button"
          ...
          {tab === "loads" ? (
            <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-[200px_1fr] lg:gap-4 lg:p-6">
              <div
                className={`space-y-1 overflow-y-auto p-2 lg:rounded-xl lg:border lg:border-[var(--color-border)] ${
                  loadChatOpen ? "hidden lg:block" : "block"
                }`}
              >
                {loadThreads.map((t) => (
                  <button
              ...
              <div
                className={`min-h-0 ${
                  loadChatOpen ? "flex flex-col" : "hidden lg:flex"
                }`}
              >
                {activeLoadId ? (
                  <FreightChatPanel
                  ...
                  <p className="hidden p-6 text-sm text-[var(--color-muted)] lg:block">
                    Select a load chat
                  </p>
                )}
              </div>
            ...
            <div className="grid min-h-0 flex-1 grid-cols-1 lg:grid-cols-3 lg:gap-4 lg:p-6">
              <div
                className={`border-b border-[var(--color-border)] p-3 lg:col-span-1 lg:border-0 lg:p-0 ${
                  dispatchOpen ? "hidden lg:block" : "block"
                }`}
              >
                <button
                  type="button"
              ...
              <div
                className={`min-h-0 flex-col lg:col-span-2 ${
                  dispatchOpen ? "flex" : "hidden lg:flex"
                }`}
              >
                <div className="flex min-h-0 flex-1 flex-col overflow-hidden bg-[#0a1018] lg:rounded-2xl lg:border lg:border-[var(--color-border)]">
                  <div className="flex shrink-0 items-center gap-2 border-b border-[var(--color-border)] bg-[var(--color-surface)]/60 px-3 py-3 lg:hidden">
                    <button
                      type="button"
